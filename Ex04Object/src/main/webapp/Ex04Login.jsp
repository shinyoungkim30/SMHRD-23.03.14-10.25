...
<body>
	...
	if (id.equals("smart") && pw.equals("123")) {
		...
		// response.sendRedirect("Ex04LoginSuccess.jsp?id=" + id);
		
		// 2. request 객체를 다음 페이지로 넘겨주는 방법(공유하는 방법) => forwarding(포워딩)
		// RequestDispatcher : 클라이언트로부터 최초에 들어온 요청(request)을 원하는 자원으로 넘기는 등의 메서드 가지고 있는 객체
